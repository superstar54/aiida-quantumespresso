...
from aiida.orm import Dict, KpointsData, load_code, load_group, StructureData, Float
...
wt = WorkTree('Bands')
bands_job = wt.nodes.new(bands_worktree, name='bands_group', run_relax=True,
                         bands_kpoints_distance=Float(0.2),
                         structure=structure_si, inputs=bands_inputs)
wt.run()
